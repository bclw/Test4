...
public class Nefollows {
	...
	public String toString() {
		return "Nefollows [nId=" + nId + ", nStudentId=" + nStudentId
				+ ", nStudentName=" + nStudentName + ", nFollowTime="
				+ nFollowTime + ", nNextFollowTime=" + nNextFollowTime
				+ ", nContent=" + nContent + ", nUserId=" + nUserId
				+ ", nFollowType=" + nFollowType + ", nCreateTime="
				+ nCreateTime + ", nFollowState=" + nFollowState + ", s=" + s
				+ "]";
	}
