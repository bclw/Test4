...
public String toString() {
	return "Student [sId=" + sId + ", sName=" + sName + ", sAge=" + sAge
			+ ", sSex=" + sSex + ", sPhone=" + sPhone + ", sStuState="
			+ sStuState + ", sState=" + sState + ", sMsgSource=" + sMsgSource
			+ ", sSourceUrl=" + sSourceUrl + ", sSourceKeyWord="
			+ sSourceKeyWord + ", sAddress=" + sAddress + ", sNetPusherId="
			+ sNetPusherId + ", sStuConcern=" + sStuConcern + ", sQQ=" + sQQ
			+ ", sWeiXin=" + sWeiXin + ", sContent=" + sContent
			+ ", sCreateTime=" + sCreateTime + ", sLearnForward="
			+ sLearnForward + ", sIsValid=" + sIsValid + ", sRecord=" + sRecord
			+ ", sIsReturnVist=" + sIsReturnVist + ", sFirstVisitTime="
			+ sFirstVisitTime + ", sIsHome=" + sIsHome + ", sHomeTime="
			+ sHomeTime + ", sLostValid=" + sLostValid + ", sIsPay=" + sIsPay
			+ ", sPayTime=" + sPayTime + ", sMoney=" + sMoney
			+ ", sIsReturnMoney=" + sIsReturnMoney + ", sReturnMoneyReason="
			+ sReturnMoneyReason + ", sIsInClass=" + sIsInClass
			+ ", sInClassTime=" + sInClassTime + ", sInClassContent="
			+ sInClassContent + ", sIsBaoBei=" + sIsBaoBei + ", sZiXunId="
			+ sZiXunId + ", sCreateUserId=" + sCreateUserId + ", sPreMoney="
			+ sPreMoney + ", sPreMoneyTime=" + sPreMoneyTime + "]";
}
